...
async function populate() {
    ...
    if (count == 0) {
        ...
        const users = await User.bulkCreate([
            { fullname: "mustafa kemal", email: "info@mustafakemal.com", password: await bcrypt.hash("135790", 10) },
            { fullname: "murat varol", email: "info@muratvarol.com", password: await bcrypt.hash("135790", 10) },
            { fullname: "eren ciftci", email: "info@erenciftci.com", password: await bcrypt.hash("135790", 10) },
            { fullname: "yusuf ciftci", email: "info@yusufciftci.com", password: await bcrypt.hash("135790", 10) },
